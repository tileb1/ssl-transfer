...
########################################################################
#sbatch job.sh 'dino_vitsmall16_pretrain_full_checkpoint' 'aircraft'
#sbatch job.sh 'dino_vitsmall16_pretrain_full_checkpoint' 'cifar10'
#sbatch job.sh 'dino_vitsmall16_pretrain_full_checkpoint' 'cifar100'
#sbatch job.sh 'dino_vitsmall16_pretrain_full_checkpoint' 'dtd'
#sbatch job.sh 'dino_vitsmall16_pretrain_full_checkpoint' 'flowers'
#sbatch job.sh 'dino_vitsmall16_pretrain_full_checkpoint' 'pets'
#sbatch job.sh 'dino_vitsmall16_pretrain_full_checkpoint' 'food'
#sbatch job.sh 'dino_vitsmall16_pretrain_full_checkpoint' 'cars'
